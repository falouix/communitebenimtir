...
<div class="container">
    <ol class="breadcrumb">
        ...
        <li class="active">Nouveau Poll</li>
    </ol>
    <div class="well col-md-8 col-md-offset-2">
        ...
        <form method="POST" action=" {{ route('poll.store') }}">
            ...
            <div class="form-group">
                ...
                <textarea id="question" name="question" cols="30" rows="2" class="form-control" placeholder="Question Ar / Question Fr / Question En">{{ old('question') }}</textarea>
            </div>
            <div class="form-group">
                <label>Options</label>
                <ul id="options">
                    <li>
                        <input id="option_1" type="text" name="options[0]" class="form-control add-input" value="{{ old('options.0') }}" placeholder="Option Ar / Option Fr / Option En" />
                    </li>
                    <li>
                        <input id="option_2" type="text" name="options[1]" class="form-control add-input" value="{{ old('options.1') }}" placeholder="Option Ar / Option Fr / Option En" />
                    </li>
                </ul>
