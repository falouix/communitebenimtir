...
@section('content')
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="active">Ajouter Options</li>
        </ol>
        <div class="well col-md-8 col-md-offset-2">
            @if($errors->any())
                <div class="alert alert-danger">
                    <span>Veuillez remplir tous les champs svp!</span>
                </div>
            @endif
            <form method="POST" action=" {{ route('poll.options.add', $poll->id) }}">
                ...
                <div class="form-group">
                    <ul id="options">
                        <li>
                            <input type="text" name="options[0]" class="form-control add-input" placeholder="Insérer l'option" />
...
@section('js')
    <script type="text/javascript">
        ...
        document.getElementById("add").onclick = function() {
            ...
            e.innerHTML = "<input type='text' name='options[]' class='form-control add-input' placeholder='Taper option...' /> <a class='btn btn-danger' href='#' onclick='remove(this)'><i class='fa fa-minus-circle' aria-hidden='true'></i></a>";
