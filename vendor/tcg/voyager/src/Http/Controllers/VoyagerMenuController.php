...
class VoyagerMenuController extends Controller
{
    public function builder($id)
    {
        ...
        $pages= \App\Article::Where('status','=','PUBLISHED')->get();
        //dd($menu);
        //compact('menu', 'isModelTranslatable')
        return Voyager::view('voyager::menus.builder')->with(compact('menu', 'isModelTranslatable'))
                                                      ->with(compact('pages'));
    }
