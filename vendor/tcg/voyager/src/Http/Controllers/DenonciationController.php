...
class DenonciationController extends Controller
{
    ...
    /*********************************************************
                   Consulter denonciation
    **********************************************************/
    public function ConsulterDenonciation(Request $request, $id)
    {
        $slug = $this->getSlug($request);
        //dd($slug);
        $dataType = Voyager::model('DataType')->where('slug', '=', $slug)->first();
        $Denonciation = Denonciation::where('id', $id)->first();
        //dd($reclamation);
        $slug = $this->getSlug($request);
        $dataType = Voyager::model('DataType')->where('slug', '=', $slug)->first();
        $isSoftDeleted = false;
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'isSoftDeleted','Denonciation'));
    }
    /*********************************************************
