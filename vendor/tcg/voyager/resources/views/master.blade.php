...
<head>
    ...
    <link rel="stylesheet" href="{{ voyager_asset('lib/custom.css') }}">
    @yield('css')
...
?>
    ...
    <script type="text/javascript" src="{{ voyager_asset('js/chartjs/dist/Chart.min.js') }}"></script>
    <script type="text/javascript" src="{{ voyager_asset('js/chartjs/dist/utils.js') }}"></script>
    <script>
