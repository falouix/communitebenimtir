...
<div class="page-content container-fluid">
    <form class="form-edit-add" role="form"
        action="@if(isset($dataTypeContent->id)){{ route('voyager.contacts.update', $dataTypeContent->id) }}@else{{ route('voyager.contacts.store') }}@endif"
            ...
            <div class="col-md-8">
                ...
                <div class="page-content compass container panel panel panel-bordered panel-primary " style="padding: 0px;">
                    <ul class="nav nav-tabs panel-heading">
                        ...
                        <li class="panel-title"><a data-toggle="tab" href="#Infos" aria-expanded="false"  style="color: white;">
                        Contact</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content" >
                        ...
                        <div class="form-group">
                            <label for="slug">Service</label>
                            <input type="text" class="form-control" id="service_fr" name="service_fr"
                                        placeholder="Service..."
                                        value="{{ $dataTypeContent->service_fr ?? '' }}" autocomplete="off"> 
                        </div>
                        </div>
                        <div id="AR" class="tab-pane fade " style="direction: rtl;">
                            ...
                            <input type="text" class="form-control" id="adresse_ar" name="adresse_ar"
                                        placeholder=" العنوان " value="{{ $dataTypeContent->adresse_ar ?? '' }}" autocomplete="off">
                        </div>
                        <div class="form-group">
                            <label for="slug">المصلحة</label>
                            <input type="text" class="form-control" id="service_ar" name="service_ar"
                                        placeholder="المصلحة..."
                                        value="{{ $dataTypeContent->service_ar ?? '' }}" autocomplete="off"> 
                        </div>
                        </div>
                        <div id="EN" class="tab-pane fade">
                            ...
                            <input type="text" class="form-control" id="adresse_en" name="adresse_en"
                                        placeholder="Adress" value="{{ $dataTypeContent->adresse_en ?? '' }}" autocomplete="off">
                        </div>
                         <div class="form-group">
                            <label for="slug">Service</label>
                            <input type="text" class="form-control" id="service_en" name="service_en"
                                        placeholder="Service..."
                                        value="{{ $dataTypeContent->service_en ?? '' }}" autocomplete="off"> 
                        </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="telephone" name="telephone"
                                        placeholder="telephone" value="{{ $dataTypeContent->telephone ?? '' }}" autocomplete="off">
                        </div>
                        <div class="form-group">
                            <label for="slug">E-mail</label>
                            <input type="email" class="form-control" id="email" name="email"
                                        placeholder="E-mail" value="{{ $dataTypeContent->email ?? '' }}" autocomplete="off">
                        </div>
                        <div class="form-group">
                            <label for="slug">Fax</label>
                            <input type="text" class="form-control" id="fax" name="fax"
                                        placeholder="Fax" value="{{ $dataTypeContent->fax ?? '' }}" autocomplete="off">
                        </div>
                        </div>
                    </div>
                </div>
