                    ...
                    <div class="tab-content">
                        <div id="FR" class="tab-pane fade active in">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="TitreFR" name="TitreFR"
                                    placeholder="Le titre de document" value="{{ $dataTypeContent->TitreFR ?? '' }}"
                                    autocomplete="off">
                            </div>
                        </div>
                        <div id="AR" class="tab-pane fade" style="direction: rtl;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="TitreAR" name="TitreAR"
                                    placeholder="اكتب إسم الوثيقة" value="{{ $dataTypeContent->TitreAR ?? '' }}"
                                    autocomplete="off">
                            </div>
                        </div>
