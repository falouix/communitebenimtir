...
<div class="page-content container-fluid">
    <form class="form-edit-add" role="form"
        action="@if(isset($dataTypeContent->id)){{ route('voyager.projets-realisations.update', $dataTypeContent->id) }}@else{{ route('voyager.projets-realisations.store') }}@endif"
                ...
                <div class="page-content compass container panel panel panel-bordered panel-primary "
                    ...
                    <div class="tab-content">
                        ...
                        <div id="images" class="tab-pane fade">
                            ...
                            <div class="form-group">
                                <label for="TypeProjet">Type de document</label>
                                <select class="form-control" name="TypeProjet">
                                    <option value="PROJETDANSPIC" @if(isset($dataTypeContent->TypeProjet) &&
                                        $dataTypeContent->TypeProjet == 'PROJETDANSPIC')
                                        selected="selected"@endif>مشاريع داخل برنامج الإستثمار البلدي</option>
                                    <option value="PROJETHORSPIC" @if(isset($dataTypeContent->TypeProjet) &&
                                        $dataTypeContent->TypeProjet ==
                                        'PROJETHORSPIC') selected="selected"@endif>مشاريع خارج برنامج الإستثمار البلدي</option>
                                    <option value="PLANINVESTISSEMENT" @if(isset($dataTypeContent->TypeProjet) && $dataTypeContent->TypeProjet
                                        == 'PLANINVESTISSEMENT') selected="selected"@endif>مخطط الإستثمار السنوي
                                    </option>
                                    <option value="EVALUATIONREALISATION" @if(isset($dataTypeContent->TypeProjet) && $dataTypeContent->TypeProjet
                                        == 'EVALUATIONREALISATION') selected="selected"@endif>تقييم تقدم المشاريع
                                    </option>
                                </select>
                            </div>
                        </div>
