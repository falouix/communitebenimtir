                ...
                <div class="main-content">
                    ...
                    <div class="main-content-header clearfix">
                        <div class="pull-right">
                            <h3 class="line-bottom-theme-colored-3"> {{ __('routes.ProtectionSocioEnvi') }}</h3>
                        </div>
                        <div class="pull-search">
                            <form class="booking_form_area text-center"
                                action="{{ url('/protection-socio-environemental/search') }}" method="GET"
                                role="search">
                                @csrf
                                <div class="col-md-5 custom-col3">
                                    <label>{{ __('libelle.SearchPlaceHolder') }}</label>
                                    <input type="text" name="type" class="date input-name form-control" min="1956"
                                        max="2100" placeholder={{ __('libelle.SearchPlaceHolder') }}>
                                </div>
