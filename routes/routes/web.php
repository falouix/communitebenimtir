...
Route::get('/actualites/indexAttente', [ControllerName::class, 'indexAttente'])->name('voyager.actualites.indexAttente');
Route::get('/actualites/indexArchive', [ControllerName::class, 'indexArchive'])->name('voyager.actualites.indexArchive');
Route::get('/articles/indexAttente', [ControllerName::class, 'indexAttente'])->name('voyager.articles.indexAttente');
Route::get('/articles/indexArchive', [ControllerName::class, 'indexArchive'])->name('voyager.articles.indexArchive');
