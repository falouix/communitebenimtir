...
@section('content')
    <div class="col-12">
        ...
        <a type="button" class="btn btn-success" href="{{ route("citoyen.messages") }}"><i
                class="fa fa-angle-double-right"></i> قائمة الرسائل</a>
        </div>
            ...
            <!-- form start -->
                ...
                <div class="card-body">
                    ...
                    <div class="form-group col-lg-12 col-md-12">
                        ...
                        <input type="text" class="form-control" name="Sujet" id="Sujet" disabled autocomplete="false" value="{{ $msg->Sujet }}">
                    </div>
                    
                    @isset($msg->Textmessage)
<div class="form-group col-lg-12 col-md-12">
    <label for="Textmessage">نص الرسالة :</label>
    {!! $msg->Textmessage !!}
</div>
                    @endisset
                ...
                <div class="card-footer" style="background: white;">
                    <ul class="mailbox-attachments clearfix">
                        @isset($msg->PiecesJointes)
                            @foreach(json_decode($msg->PiecesJointes, true) as $fichier)
                            @php
        ...
        @foreach ($ReponsesMsg as $reponse)
        ...
        <div class="card card-primary">
            ...
            <form action="" enctype="multipart/form-data" method="post">
                @csrf
                <div class="card-body">
                    <input type="hidden" value="{{ $msg->id }}" name="id_message_prive">
