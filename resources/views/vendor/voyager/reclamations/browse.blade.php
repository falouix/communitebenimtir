...
<!--/start EtatReclamation modal -->
{{-- EtatReclamation_modal modal --}}
<div class="modal modal-warning fade" tabindex="-1" id="EtatReclamation_modal" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('voyager.'.$dataType->slug.'.index') }}" id="EtatReclamation_form" method="GET">
                {{ csrf_field() }}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"
                        aria-label="{{ __('voyager::generic.close') }}"><span aria-hidden="true">&times;</span></button>
                ...
                <div class="modal-footer">
                    <input type="submit" class="btn btn-warning pull-right EtatReclamation-confirm" value="Oui">
                    <button type="button" class="btn btn-default pull-right"
                        data-dismiss="modal">{{ __('voyager::generic.cancel') }}</button>
                </div>
            </form>
...
<script>
    $(document).ready(function () {
        ...
        //EtatReclamation
        var EtatReclamationFormAction;
        $('td').on('click', '.EtatReclamation', function (e) {
        $('#EtatReclamation_form')[0].action = '{{ route('voyager.'.$dataType->slug.'.EtatRecl', ['id' => '__id']) }}'.replace('__id', $(this).data('id'));
        $('#EtatReclamation_modal').modal('show');
        });
