        ...
        <div class="col-md-12">
                ...
                <div class="panel-body">
                    <div class="card card-rec card-outline">
                        ...
                        <div class="card-footer bg-white">
                            @foreach(json_decode($DemandeAcces->PiecesJointes, true) as $fichier)
                            @php
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-footer bg-white">
                            @foreach(json_decode($ReponseDemandeAcces->PiecesJointes, true) as $fichier)
                            @php
                            $split = explode("/", $fichier);
                            @endphp
                            <div class="card-body pad-top-0 bg-white">
            ...
            <div class="panel panel-bordered panel-info">
                ...
                <div class="panel-body" style="">
                    <form action="{{ route('voyager.'.$dataType->slug.'.RepondreDemandeAcces') }}" method="POST"
