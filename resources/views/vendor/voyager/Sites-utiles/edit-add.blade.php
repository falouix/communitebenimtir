...
<div class="page-content container-fluid">
    <form class="form-edit-add" role="form"
        action="@if(isset($dataTypeContent->id)){{ route('voyager.sites-utiles.update', $dataTypeContent->id) }}@else{{ route('voyager.sites-utiles.store') }}@endif"
            ...
            <div class="col-md-8">
                ...
                <div class="page-content compass container panel panel panel-bordered panel-primary " style="padding: 0px;">
                    <ul class="nav nav-tabs panel-heading">
                        ...
                        <li class="panel-title"><a data-toggle="tab" href="#image" aria-expanded="false"  style="color: white;">
                                Image</a>
                        </li>
