...
<div class="page-content container-fluid">
    <form class="form-edit-add" role="form"
        action="@if(isset($dataTypeContent->id)){{ route('voyager.themes.update', $dataTypeContent->id) }}@else{{ route('voyager.themes.store') }}@endif"
                    ...
                    <div class="tab-content">
                        <div id="FR" class="tab-pane fade active in">
                            ...
                            <div class="form-group">
                                <label for="slug">Théme</label>
                                <input type="text" class="form-control" id="theme_fr" name="theme_fr"
                                    placeholder="Le nom du théme"
                                    value="{{ $dataTypeContent->theme_fr ?? '' }}" autocomplete="off">
                            </div>
                            <div class="form-group">
                        ...
                        <div id="AR" class="tab-pane fade " style="direction: rtl;">
                            <!-- ### TITLE ### -->
                            <div class="form-group">
                                <label for="slug">الموضوع</label>
                                <input type="text" class="form-control" id="theme_ar" name="theme_ar"
                                    placeholder="اكتب إسم الموضوع القانوني" value="{{ $dataTypeContent->theme_ar ?? '' }}"
                                    autocomplete="off">
                            </div>
                            <div class="form-group">
                        ...
                        <div id="EN" class="tab-pane fade">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="theme_en" name="theme_en" placeholder="The name of the theme"
                                    value="{{ $dataTypeContent->theme_en ?? '' }}" autocomplete="off">
                            </div>
                            <div class="form-group">
