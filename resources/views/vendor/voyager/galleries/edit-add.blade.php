...
<div class="page-content container-fluid">
    <form class="form-edit-add" role="form"
        action="@if(isset($dataTypeContent->id)){{ route('voyager.galleries.update', $dataTypeContent->id) }}@else{{ route('voyager.galleries.store') }}@endif"
                    ...
                    <div class="tab-content">
                        ...
                        <div id="images" class="tab-pane fade">
                            <div class="form-group">
                                ...
                                @php
                                $dataTypeRows = $dataType->{(isset($dataTypeContent->id) ? 'editRows' : 'addRows' )};
                                $row = $dataTypeRows->where('field', 'cover')->first();
                                @endphp
                                {!! app('voyager')->formField($row, $dataType, $dataTypeContent) !!}
                            </div>
                            <div class="form-group">
                                <label for="slug">Videos</label>
                                @php
                                $dataTypeRows = $dataType->{(isset($dataTypeContent->id) ? 'editRows' : 'addRows' )};
                                $row = $dataTypeRows->where('field', 'videos')->first();
                                @endphp
                                {!! app('voyager')->formField($row, $dataType, $dataTypeContent) !!}
                            </div>
                            <div class="form-group">
                                <label for="slug">Lien YouTube</label>
                                <input type="text" class="form-control" id="lienyoutube" name="lienyoutube"
                                    placeholder="Lien YouTube" value="{{ $dataTypeContent->lienyoutube ?? '' }}"
                                    autocomplete="off">
                            </div>
                            <div class="form-group">
            ...
            <div class="col-md-4">
                ...
                <div class="panel panel panel-bordered panel-warning">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label for="slug">Date début</label>
                            @php
                            $dataTypeRows = $dataType->{(isset($dataTypeContent->id) ? 'editRows' : 'addRows' )};
                        ...
                        <div class="form-group">
                            <label for="featured">YouTube</label>
                            <input type="checkbox" name="youtube" @if(isset($dataTypeContent->youtube) &&
                            $dataTypeContent->youtube) checked="checked"@endif>
                        </div>
                        <div class="form-group">
                            <label for="slug">Type</label>
                            @php
                            $dataTypeRows = $dataType->{(isset($dataTypeContent->id) ? 'editRows' : 'addRows' )};
                            $row = $dataTypeRows->where('field', 'type')->first();
                            @endphp
                            {!! app('voyager')->formField($row, $dataType, $dataTypeContent) !!}
                        </div>
