...
<div class="page-content container-fluid">
    <form class="form-edit-add" role="form"
        action="@if(isset($dataTypeContent->id)){{ route('voyager.monuments-religieus.update', $dataTypeContent->id) }}@else{{ route('voyager.monuments-religieus.store') }}@endif"
                    ...
                    <div class="tab-content">
                        <div id="FR" class="tab-pane fade active in">
                            ...
                            <div class="form-group">
                                <label for="slug">Nom du monument religieux</label>
                                <input type="text" class="form-control" id="libelle_fr" name="libelle_fr"
                                    placeholder="Nom du monument " value="{{ $dataTypeContent->libelle_fr ?? '' }}"
                                    autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label for="slug">Adresse</label>
                                <input type="text" class="form-control" id="adresse_fr" name="adresse_fr"
                                    placeholder="L'adresse du monument" value="{{ $dataTypeContent->adresse_fr ?? '' }}"
                                    autocomplete="off">
                            </div>
                            <div class="form-group">
                        ...
                        <div id="AR" class="tab-pane fade" style="direction: rtl;">
                            <!-- ### TITLE ### -->
                            <div class="form-group">
                                <label for="slug">إسم المعلم الديني</label>
                                <input type="text" class="form-control" id="libelle_ar" name="libelle_ar"
                                    placeholder="إسم المعلم الديني" value="{{ $dataTypeContent->libelle_ar ?? '' }}"
                                    autocomplete="off">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="slug">تقديم المعلم الديني</label>
                                @php
                                $dataTypeRows = $dataType->{(isset($dataTypeContent->id) ? 'editRows' : 'addRows'
                                )};
                        ...
                        <div id="images" class="tab-pane fade">
                            ...
                            <div class="form-group">
                                ...
                                $row = $dataTypeRows->where('field', 'site_web')->first();
                                @endphp
                                {!! app('voyager')->formField($row, $dataType, $dataTypeContent) !!}
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="slug">Photo de couverture</label>
                                @php
                                $dataTypeRows = $dataType->{(isset($dataTypeContent->id) ? 'editRows' : 'addRows' )};
                                $row = $dataTypeRows->where('field', 'image_couverture')->first();
                                @endphp
                                {!! app('voyager')->formField($row, $dataType, $dataTypeContent) !!}
                            </div>
                            <div class="form-group">
