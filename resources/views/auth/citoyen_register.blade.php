...
<div class="card-body login-card-body">
    ...
    <form method="POST" action="">
        ...
        <div class="input-group mb-3">
            <input type="text" class="form-control" placeholder="رقم بطاقة التعريف الوطنية" name="CIN" required
                autocomplete="off">
            <div class="input-group-append">
                <span class="fa fa-user input-group-text"></s pan>
            </div>
        </div>
        <div class="input-group mb-3">
            <input type="text" class="form-control" placeholder="الاسم و اللقب" name="NomPrenom" required
                autocomplete="off">
            <div class="input-group-append">
        ...
        <div class="input-group mb-3">
            <input type="text" class="form-control" placeholder="رقم الهاتف" name="Tel" autocomplete="off">
            <div class="input-group-append">
        ...
        <div class="input-group mb-3">
            <input type="password" class="form-control" placeholder="تأكيد كلمة السر" name="confirmpassword" required
                autocomplete="off">
            <div class="input-group-append">
                <span class="fa fa-lock input-group-text"></span>
            </div>
