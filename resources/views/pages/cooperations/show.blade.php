...
$urlName[1] = str_limit( $coop->$titre , $limit=55, $end='...');
$IsActive[0] ='';
$IsActive[1] ='active';
$urlBread[0] ='/cooperations';
$urlBread[1] = $coop->slug ? $coop->slug : '';
@endphp
@section('content')
        ...
        <div class="col-md-9 col-xs-12">
            <div class="main-content">
                ...
                <div class="news-content-area">
                    <!-- SINGLE NEWS  -->
                    <h3 class="media-heading line-bottom-theme-colored-2">{{ $coop->$titre }}</h3>
                    <div class=" media-area">
                        <div class="single-news">
                            <a href="#">
                                <img class="img-responsive" data-src="{{ voyager::image($coop->vignette) }}"
                                    alt="{{ $coop->$titre }}" class="lazyload">
                        ...
                        <div class="owl-carousel-news">
                            ...
                            <div class="owl-carousel owl-theme">
                                @foreach(json_decode($coop->carousel, true) as $image)
                                <div class="item">
